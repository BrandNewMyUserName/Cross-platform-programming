...
export class CloudPage implements OnInit {
  ...
  //     data: {
  //       // Дані по Осі X
  //       labels: this.toDoList.records.map((data) => data.title),

  //       datasets: [ 
  //         {
  //           label: 'Перелік справ по складності',
  //           borderColor: 'rgba(75,192,192,1)',
  //           // Дані по Осі Y
  //           data: this.toDoList.records.map((data) => data.difficulty),
